...
import Image1 from '../../assets/virtual.png'
    ...
    <div className='py-8'>
                <div className='container'>
                    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {/* first col*/}
                        <div className='col-span-2 py-10 pl-5 bg-gradient-to-b from-gray-300/100 to-gray-400 /60 relative rounded-3xl text-white h-[320px] flex items-end'>
                            <div>
                                <div className=' space-y-2 mb-4'>
                                    <p className='mb-4'>Enjoy</p>
                                    <p className='mb-[2px] text-gray-100'>With</p>
                                    <p className='text-3xl lg:text-5xl font-bold opacity-100 mb-4'>Laptop</p>
                        ...
                        <div className='py-10 pl-5 bg-gradient-to-b from-black 90 to-brandYellow/60 text-white rounded-3xl relative h-[320px] flex items-end '>
                            ...
                            <img src={Image2} alt="earphone" className='w-[150px]  absolute -right-2 lg:top-[100px]' />
                        </div>
                        {/* third col*/}
                        <div className='py-10 pl-5 bg-gradient-to-b from-brandGreen 90 to-green/60 text-white rounded-3xl relative h-[320px] flex items-end '>
                            <div>
                                <div>
                                    <p className='mb-4'>Enjoy</p>
                                    <p className='mb-[2px] text-gray-400 '>with</p>
